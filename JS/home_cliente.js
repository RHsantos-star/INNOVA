...
(function () {
  ...
  async function listarBannersCarrossel({
    ...
    urlCandidates = [
      "../PHP/cadastrar_banner.php?listar=1",   // se o HTML estiver em PAGINAS_CLIENTE/
      "PHP/cadastrar_banner.php?listar=1",      // se o HTML estiver na raiz do projeto
      "../../PHP/cadastrar_banner.php?listar=1" // se o HTML estiver uma pasta mais fundo
    ],
    apenasValidos = true
  } = {}) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    listarBannersCarrossel({
      ...
      urlCandidates: ["../PHP/cadastrar_banner.php?listar=1", "PHP/banners.php?listar=1", "../../PHP/banners.php?listar=1"],
      apenasValidos: true
    });
  });
})();
